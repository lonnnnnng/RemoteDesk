...
// 作者: long；960x624 是模拟器的清晰/解码平衡点，避免 720p 在 Android 端长期掉到 10fps 以下，同时不再把 480p 拉伸到全屏。
const EMULATOR_SESSION_MAX_WIDTH = 960
...
const EMULATOR_SESSION_MAX_PROFILE_INDEX = 1
const EMULATOR_SESSION_MAX_SCALE_DOWN_BY = 1.0
const ANDROID_PHONE_SESSION_PROFILE_INDEX = 2
// 作者: long；H.264 native sender 已经稳定输出完整 SPS/PPS/IDR/Delta，普通真机会话恢复到 720p 上限，避免手机端全屏只是放大 544p 诊断帧。
...
const ANDROID_PHONE_SESSION_MAX_BITRATE = 10000000
