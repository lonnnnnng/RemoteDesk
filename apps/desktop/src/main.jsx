...
// 作者: long；MTK 真机 H.264 首帧还没稳定前，标准会话先落到 16 对齐的保守档，避免高分辨率把 decoder init 诊断结果混在一起。
const ANDROID_PHONE_SESSION_MAX_WIDTH = 960
const ANDROID_PHONE_SESSION_MAX_HEIGHT = 544
const ANDROID_PHONE_SESSION_MAX_FPS = 24
const ANDROID_PHONE_SESSION_MAX_BITRATE = 6400000
